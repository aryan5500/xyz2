...
class music(commands.Cog):
    ...
    @commands.command(name='clearq', aliases=['clr', 'cl', 'cr'], description="clears entire queue")
    ...
    @commands.command(name='leave', aliases=["stop", "disconnect", "bye"], description="stops music and disconnects from voice")
